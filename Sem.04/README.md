...
```c++
<тип_резултат> <идентификатор>(<параметър>, <параметър> ...)
{
      <тяло>
}
```
...
- Ако параметър е примитивен тип данна или някакъв обект, то се създава нова променлива/обект в scope-а на функцията (копие, pass by value).
